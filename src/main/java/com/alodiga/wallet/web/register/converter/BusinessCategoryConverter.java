 ...
 * @author hvarona
 */
@ManagedBean(name = "businessCategoryConverter")
@ViewScoped
public class BusinessCategoryConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        ...
        try {
            return registerController.getBusinessCategory(Long.parseLong(submittedValue));
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            if (value instanceof BusinessCategory) {
                return Long.toString(((BusinessCategory) value).getId());
            } else {
